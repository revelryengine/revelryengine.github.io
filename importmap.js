...
element.textContent = JSON.stringify({
    imports: {
        ...
        'revelryengine/gltf/'                : 'https://cdn.jsdelivr.net/gh/revelryengine/gltf@v0.1.1-alpha/',
        'revelryengine/renderer/'            : 'https://cdn.jsdelivr.net/gh/revelryengine/renderer@v0.1.4-alpha/',
