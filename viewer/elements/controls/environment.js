...
class WebGLTFViewerControlEnvironmentElement extends WebGLTFParamElement {
  ...
  updated(changedProperties) {
    ...
    } else if(changedProperties.has('punctualoff')) {
  ...
  render(){
    ...
    return html`
      <webgltf-viewer-control-group name="Environment">
...
customElements.define('webgltf-viewer-control-environment', WebGLTFViewerControlEnvironmentElement);
